...
class SteamPuller(BasePuller):
    PULL_URL_TEMPLATE = 'https://store.steampowered.com/search/results/?query={query}&start={offset}&tags={tags}&count=50&filter={page_type}&dynamic_data=&sort_by=_ASC&infinite=1&os={os}'
    base_headers = {
